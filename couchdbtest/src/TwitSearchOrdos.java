...
public class TwitSearchOrdos {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		CouchDbClient db = new CouchDbClient("couchdbordos.properties");
		...
		cb.setDebugEnabled(true)
				.setOAuthConsumerKey("JDRSulhTOQVyNEjrZ0tRKg")
				.setOAuthConsumerSecret(
						"y3RPBmRAR7B3mzsxbWGEi9gKqN1OjLy8bsxTVfQkQE")
				.setOAuthAccessToken(
						"1889233045-SAHItV4PAZ7xI7akgsjqiNBT2mFjfv5CqZeMWMJ")
				.setOAuthAccessTokenSecret(
						"hK49POqt8np222B75T0MfVwsDhVOfnrRQA6x9fl2YY");
